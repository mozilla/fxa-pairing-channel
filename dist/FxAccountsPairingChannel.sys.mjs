 ...
 * 
 * Bundle generated from https://github.com/mozilla/fxa-pairing-channel.git. Hash:310b6dc24a927c6ef9bb, Chunkhash:70e4df979dabbf6a6fceadc36012a830.
 *
 */
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "fN": () => (/* reexport */ TLSCloseNotify)
});

// UNUSED EXPORTS: TLSError, _internals, base64urlToBytes, bytesToBase64url, bytesToHex, bytesToUtf8, hexToBytes, utf8ToBytes
...
class UNINITIALIZED extends State {
  async initialize() {
...
class CLIENT_START extends State {
  async initialize() {
...
class CLIENT_CONNECTED extends CONNECTED {
  async recvHandshakeMessage(msg) {
...
class SERVER_START extends State {
  async recvHandshakeMessage(msg) {
...
class EncryptionState extends CipherState {
...
class DecryptionState extends CipherState {
  static async create(key) {
...
class ClientConnection extends Connection {
  static async create(psk, pskId, sendCallback) {
    ...
    await instance._transition(CLIENT_START);
    return instance;
  }
}
...
class ServerConnection extends Connection {
  static async create(psk, pskId, sendCallback) {
    const instance = await super.create(psk, pskId, sendCallback);
    await instance._transition(SERVER_START);
    return instance;
  }
}
...
class PairingChannel extends event_target_shim.EventTarget {
...
__webpack_exports__ = __webpack_exports__.PairingChannel;
var __webpack_exports__PairingChannel = __webpack_exports__.PairingChannel;
var __webpack_exports__TLSCloseNotify = __webpack_exports__.fN;
var __webpack_exports__TLSError = __webpack_exports__.false;
var __webpack_exports___internals = __webpack_exports__.false;
var __webpack_exports__base64urlToBytes = __webpack_exports__.false;
var __webpack_exports__bytesToBase64url = __webpack_exports__.false;
var __webpack_exports__bytesToHex = __webpack_exports__.false;
var __webpack_exports__bytesToUtf8 = __webpack_exports__.false;
var __webpack_exports__hexToBytes = __webpack_exports__.false;
var __webpack_exports__utf8ToBytes = __webpack_exports__.false;
export { __webpack_exports__PairingChannel as PairingChannel, __webpack_exports__TLSCloseNotify as TLSCloseNotify, __webpack_exports__TLSError as TLSError, __webpack_exports___internals as _internals, __webpack_exports__base64urlToBytes as base64urlToBytes, __webpack_exports__bytesToBase64url as bytesToBase64url, __webpack_exports__bytesToHex as bytesToHex, __webpack_exports__bytesToUtf8 as bytesToUtf8, __webpack_exports__hexToBytes as hexToBytes, __webpack_exports__utf8ToBytes as utf8ToBytes };
